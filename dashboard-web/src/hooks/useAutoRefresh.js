 ...
 */
export function useAutoRefresh(fetchFn, intervalMs = 8000, deps = [], options = {}) {
  let actualDeps = deps;
  ...
  const { immediate = true } = actualOptions;
  const safeDeps = Array.isArray(actualDeps) ? actualDeps : [];
